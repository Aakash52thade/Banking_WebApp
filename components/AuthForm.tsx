        ...
        {user ? (
             ...
             className="space-y-8">
              ...
              <CustomInput control={form.control}
               ...
               />
                ...
                {/* if we want to save information in our database and when when
                click on submit button, then button must be disabled, because user not
                click again and saved one information again and again
                */}
          ...
          <footer className='flex justify-center gap-1'>
             ...
             <Link href={type === 'sign-in' ?
               '/sign-up' : '/sign-in'} className='form-link'>
